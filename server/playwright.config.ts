...
// docker compose stack). Point SCRIBECAT_E2E_URL at the app, base path
// included, e.g. https://localhost/ or https://localhost:9443/anna/, and
// SCRIBECAT_E2E_PASSWORD at its password. Caddy's local CA is usually not in
...
export default defineConfig({
  ...
  reporter: "list",
  use: {
    baseURL: process.env.SCRIBECAT_E2E_URL ?? "https://localhost/",
